...
; RBY
	const SFX_GET_ITEM1_1

	const SFX_GET_ITEM2_1
	const SFX_TINK_1
	const SFX_HEAL_HP_1
	const SFX_HEAL_AILMENT_1
	const SFX_START_MENU_1
	const SFX_PRESS_AB_1

	const SFX_POKEDEX_RATING_1
	const SFX_GET_KEY_ITEM_1
	const SFX_POISONED_1
	const SFX_TRADE_MACHINE_1
	const SFX_TURN_ON_PC_1
	const SFX_TURN_OFF_PC_1
	const SFX_ENTER_PC_1
	const SFX_SHRINK_1
	const SFX_SWITCH_1
	const SFX_HEALING_MACHINE_1
	const SFX_TELEPORT_EXIT1_1
	const SFX_TELEPORT_ENTER1_1
	const SFX_TELEPORT_EXIT2_1
	const SFX_LEDGE_1
	const SFX_TELEPORT_ENTER2_1
	const SFX_FLY_1
	const SFX_DENIED_1
	const SFX_ARROW_TILES_1
	const SFX_PUSH_BOULDER_1
	const SFX_SS_ANNE_HORN_1
	const SFX_WITHDRAW_DEPOSIT_1
	const SFX_CUT_1
	const SFX_GO_INSIDE_1
	const SFX_SWAP_1
	const SFX_59_1
	const SFX_PURCHASE_1
	const SFX_COLLISION_1
	const SFX_GO_OUTSIDE_1
	const SFX_SAVE_1

	const SFX_POKEFLUTE_RBY
	const SFX_SAFARI_ZONE_PA

	const SFX_LEVEL_UP_RBY

	const SFX_BALL_TOSS
	const SFX_BALL_POOF_RBY
	const SFX_FAINT_THUD
	const SFX_RUN_RBY
	const SFX_DEX_PAGE_ADDED
	const SFX_CAUGHT_MON_RBY
	const SFX_PECK_RBY
